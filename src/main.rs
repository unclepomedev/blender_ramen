...
fn main() {
    ...
    // 1. Shader Node Tree
    // ==========================================
    let shader_tree = NodeTree::new_shader(MAT_NAME);
    ...
    println!("{}", shader_tree.generate_script());

    // ==========================================
    // 2. Geometry Node Tree
    // ==========================================
    let geo_tree = NodeTree::new_geometry("LinkTest");
    ...
    println!("{}", geo_tree.generate_script());
}
